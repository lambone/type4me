...
**[下载 Type4Me v1.2.1](https://github.com/joewongjc/type4me/releases/tag/v1.2.1)** (macOS 14+)
...
下载 [Type4Me-v1.2.1.dmg](https://github.com/joewongjc/type4me/releases/download/v1.2.1/Type4Me-v1.2.1.dmg)，拖入 Applications 即可使用。仅支持云端识别引擎。
