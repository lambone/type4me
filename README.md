...
**[下载 Type4Me v1.3.4](https://github.com/joewongjc/type4me/releases/tag/v1.3.4)** (macOS 14+)
...
下载 [Type4Me-v1.3.4.dmg](https://github.com/joewongjc/type4me/releases/download/v1.3.4/Type4Me-v1.3.4.dmg)，拖入 Applications 即可使用。仅支持云端识别引擎。
