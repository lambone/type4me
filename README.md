...
提供三个版本，功能配置递进，共享配置文件，可随时替换安装：

| 版本 | 说明 | 大小 |
|------|------|------|
| **[Type4Me-v1.5.0-full.dmg](https://github.com/joewongjc/type4me/releases/download/v1.5.0/Type4Me-v1.5.0-full.dmg)** | 双模型本地识别 (SenseVoice + Qwen3-ASR) + 本地 LLM，完全离线 | ~6GB |
| **[Type4Me-v1.5.0-lite.dmg](https://github.com/joewongjc/type4me/releases/download/v1.5.0/Type4Me-v1.5.0-lite.dmg)** | 内嵌 SenseVoice 本地识别模型，开箱即用 | ~1.1GB |
| **[Type4Me-v1.5.0-cloud.dmg](https://github.com/joewongjc/type4me/releases/download/v1.5.0/Type4Me-v1.5.0-cloud.dmg)** | 仅云端识别，需配置 API Key | ~23MB |
